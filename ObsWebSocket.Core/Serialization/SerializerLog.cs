...
internal static partial class SerializerLog
{
    ...
    public static partial void LogJsonSerializationFailedForMessageWithOpcode(this ILogger logger, Exception exception, object? opCode);
    ...
    public static partial void LogDeserializedJsonMessageOp(this ILogger logger, object? op);
    [LoggerMessage(EventId = 5, Level = LogLevel.Error, Message = "JSON deserialization failed. Raw JSON: {RawJson}")]
    public static partial void LogJsonDeserializationFailedRawJson(this ILogger logger, Exception exception, object? rawJson);
    ...
    public static partial void LogJsonDeserializerExpectedJsonelementPayloadButReceived(this ILogger logger, object? dataType, object? targetType);
    [LoggerMessage(EventId = 8, Level = LogLevel.Error, Message = "JSON failed to deserialize payload to {TargetType}. Raw JSON: {Json}")]
    public static partial void LogJsonFailedToDeserializePayloadToRaw(this ILogger logger, Exception exception, object? targetType, object? json);
    ...
    public static partial void LogJsonDeserializerExpectedJsonelementPayloadButReceived2(this ILogger logger, object? dataType, object? targetType);
    ...
    public static partial void LogJsonFailedToDeserializePayloadToValue(this ILogger logger, Exception exception, object? targetType, object? json);
    [LoggerMessage(EventId = 11, Level = LogLevel.Error, Message = "MessagePack serialization failed for message with OpCode {OpCode}")]
    public static partial void LogMessagepackSerializationFailedForMessageWithOpcode(this ILogger logger, Exception exception, object? opCode);
    ...
    public static partial void LogUnexpectedErrorDuringMessagepackSerializationForOpcode(this ILogger logger, Exception exception, object? opCode);
    [LoggerMessage(EventId = 13, Level = LogLevel.Trace, Message = "Deserialized MessagePack message: Op={Op}")]
    public static partial void LogDeserializedMessagepackMessageOp(this ILogger logger, object? op);
    ...
    public static partial void LogMessagepackFailedToDeserializePayloadObjectTo(this ILogger logger, Exception exception, object? targetType, object? objectType);
    ...
    public static partial void LogMessagepackFailedToDeserializePayloadObjectTo2(this ILogger logger, Exception exception, object? targetType, object? objectType);
}
