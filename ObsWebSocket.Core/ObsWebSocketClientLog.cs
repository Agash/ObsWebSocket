...
internal static partial class ObsWebSocketClientLog
{
    ...
    public static partial void LogStartingConnectionSequenceFor(this ILogger logger, object? uri);
    ...
    public static partial void LogWaitingForIdentifiedAfterReidentifyTimeoutMs(this ILogger logger, object? timeoutMs);
    [LoggerMessage(EventId = 5, Level = LogLevel.Information, Message = "Re-identification successful. RPC Version: {RpcVersion}")]
    public static partial void LogReIdentificationSuccessfulRpcVersion(this ILogger logger, object? rpcVersion);
    ...
    public static partial void LogWaitingForResponseTimeoutMs(this ILogger logger, object? requestId, object? requestType, object? timeoutMs);
    [LoggerMessage(EventId = 9, Level = LogLevel.Error, Message = "CallAsync failed for {RequestType} ({RequestId})")]
    public static partial void LogCallasyncFailedFor(this ILogger logger, Exception exception, object? requestType, object? requestId);
    [LoggerMessage(EventId = 10, Level = LogLevel.Warning, Message = "CallAsync for {RequestType} ({RequestId}) canceled.")]
    public static partial void LogCallasyncForCanceled(this ILogger logger, object? requestType, object? requestId);
    [LoggerMessage(EventId = 11, Level = LogLevel.Error, Message = "CallAsyncValue failed for {RequestType} ({RequestId})")]
    public static partial void LogCallasyncvalueFailedFor(this ILogger logger, Exception exception, object? requestType, object? requestId);
    [LoggerMessage(EventId = 12, Level = LogLevel.Warning, Message = "CallAsyncValue for {RequestType} ({RequestId}) canceled.")]
    public static partial void LogCallasyncvalueForCanceled(this ILogger logger, object? requestType, object? requestId);
    ...
    public static partial void LogWaitingForBatchResponseTimeoutMs(this ILogger logger, object? batchRequestId, object? requestCount, object? timeoutMs);
    [LoggerMessage(EventId = 15, Level = LogLevel.Debug, Message = "Received Batch Response {BatchRequestId} ({ResultCount} results).")]
    public static partial void LogReceivedBatchResponseResults(this ILogger logger, object? batchRequestId, object? resultCount);
    [LoggerMessage(EventId = 16, Level = LogLevel.Error, Message = "CallBatchAsync failed for batch {BatchRequestId}")]
    public static partial void LogCallbatchasyncFailedForBatch(this ILogger logger, Exception exception, object? batchRequestId);
    [LoggerMessage(EventId = 17, Level = LogLevel.Warning, Message = "CallBatchAsync for {BatchRequestId} canceled.")]
    public static partial void LogCallbatchasyncForCanceled(this ILogger logger, object? batchRequestId);
    [LoggerMessage(EventId = 18, Level = LogLevel.Debug, Message = "DisconnectAsync ignored, already {ConnectionState}.")]
    public static partial void LogDisconnectasyncIgnoredAlready(this ILogger logger, object? connectionState);
    ...
    public static partial void LogMaxReconnectAttemptsReachedOrAutoReconnect(this ILogger logger, object? maxAttempts);
    ...
    public static partial void LogReconnectingAttemptAfterMs(this ILogger logger, object? attemptNumber, object? maxAttempts, object? delayMs);
    ...
    public static partial void LogConnectedAttemptButDisconnectRequestedAborting(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 29, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Handshake complete, receive loop is running.")]
    public static partial void LogAttemptHandshakeCompleteReceiveLoopIsRunning(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 30, Level = LogLevel.Information, Message = "Successfully connected and identified (Attempt {AttemptNumber}).")]
    public static partial void LogSuccessfullyConnectedAndIdentifiedAttempt(this ILogger logger, object? attemptNumber);
    ...
    public static partial void LogConnectionLoopCanceledAttempt(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 34, Level = LogLevel.Error, Message = "Authentication failed (Attempt {AttemptNumber}). Stopping.")]
    public static partial void LogAuthenticationFailedAttemptStopping(this ILogger logger, Exception exception, object? attemptNumber);
    [LoggerMessage(EventId = 35, Level = LogLevel.Warning, Message = "Connect attempt {AttemptNumber} failed. Retrying...")]
    public static partial void LogConnectAttemptFailedRetrying(this ILogger logger, Exception exception, object? attemptNumber);
    ...
    public static partial void LogWebsocketexceptionDuringConnectionReceiveAttemptRetrying(this ILogger logger, Exception exception, object? attemptNumber);
    [LoggerMessage(EventId = 37, Level = LogLevel.Error, Message = "Unexpected error in connection loop (Attempt {AttemptNumber}). Retrying...")]
    public static partial void LogUnexpectedErrorInConnectionLoopAttemptRetrying(this ILogger logger, Exception exception, object? attemptNumber);
    [LoggerMessage(EventId = 38, Level = LogLevel.Warning, Message = "Connection lost during connected state due to: {ErrorType}")]
    public static partial void LogConnectionLostDuringConnectedStateDueTo(this ILogger logger, object? errorType);
    ...
    public static partial void LogAttemptedDuplicateSubprotocolAdd(this ILogger logger, Exception exception, object? subProtocol);
    [LoggerMessage(EventId = 42, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Connecting...")]
    public static partial void LogAttemptConnecting(this ILogger logger, object? attemptNumber);
    ...
    public static partial void LogAttemptWebsocketConnectionEstablishedProtocol(this ILogger logger, object? attemptNumber, object? subProtocol);
    [LoggerMessage(EventId = 44, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Receive loop started for handshake.")]
    public static partial void LogAttemptReceiveLoopStartedForHandshake(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 45, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Waiting for Hello...")]
    public static partial void LogAttemptWaitingForHello(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 46, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Received Hello. RPC Version: {RpcVersion}")]
    public static partial void LogAttemptReceivedHelloRpcVersion(this ILogger logger, object? attemptNumber, object? rpcVersion);
    [LoggerMessage(EventId = 47, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Authentication required.")]
    public static partial void LogAttemptAuthenticationRequired(this ILogger logger, object? attemptNumber);
    [LoggerMessage(EventId = 48, Level = LogLevel.Debug, Message = "[Attempt:{AttemptNumber}] Waiting for Identified...")]
    public static partial void LogAttemptWaitingForIdentified(this ILogger logger, object? attemptNumber);
    ...
    public static partial void LogAttemptReceivedIdentifiedNegotiatedRpcVersion(this ILogger logger, object? attemptNumber, object? negotiatedRpcVersion);
    [LoggerMessage(EventId = 50, Level = LogLevel.Debug, Message = "Receive loop starting for WebSocket {HashCode}.")]
    public static partial void LogReceiveLoopStartingForWebsocket(this ILogger logger, object? hashCode);
    [LoggerMessage(EventId = 51, Level = LogLevel.Warning, Message = "WebSocket state changed to {WebSocketState} during receive loop.")]
    public static partial void LogWebsocketStateChangedToDuringReceiveLoop(this ILogger logger, object? webSocketState);
    ...
    public static partial void LogDeserializationReturnedNullLength(this ILogger logger, object? bufferLength);
    ...
    public static partial void LogWebsocketexceptionInReceiveLoopCode(this ILogger logger, Exception exception, object? webSocketErrorCode);
    ...
    public static partial void LogReceiveLoopFinishedForWebsocket(this ILogger logger, object? hashCode);
    ...
    public static partial void LogServerAcknowledgedClientClosureStatusDesc(this ILogger logger, object? webSocketCloseStatus, object? description);
    ...
    public static partial void LogServerInitiatedUnexpectedCloseStatusDesc(this ILogger logger, object? webSocketCloseStatus, object? description);
    ...
    public static partial void LogCleanupconnectiononlyDueTo(this ILogger logger, object? exceptionType, object? exceptionMessage);
    ...
    public static partial void LogDisposingWebsocketInstance(this ILogger logger, object? hashCode);
    [LoggerMessage(EventId = 68, Level = LogLevel.Debug, Message = "Finalizing disconnection... Reason: {ReasonType}")]
    public static partial void LogFinalizingDisconnectionReason(this ILogger logger, object? reasonType);
    [LoggerMessage(EventId = 69, Level = LogLevel.Information, Message = "Client definitively disconnected. Reason: {DisconnectionReason}")]
    public static partial void LogClientDefinitivelyDisconnectedReason(this ILogger logger, object? disconnectionReason);
    [LoggerMessage(EventId = 70, Level = LogLevel.Error, Message = "Unexpected incoming message type encountered: {MessageType}")]
    public static partial void LogUnexpectedIncomingMessageTypeEncountered(this ILogger logger, object? messageType);
    ...
    public static partial void LogReceivedMessageWithUnhandledOpcode(this ILogger logger, object? opCode);
    ...
    public static partial void LogProcessingRequestresponseForRequestidStatus(this ILogger logger, object? requestId, object? statusResult);
    [LoggerMessage(EventId = 76, Level = LogLevel.Warning, Message = "Received response for unknown or timed out RequestId: {RequestId}")]
    public static partial void LogReceivedResponseForUnknownOrTimedOut(this ILogger logger, object? requestId);
    [LoggerMessage(EventId = 77, Level = LogLevel.Error, Message = "Exception during processing of RequestResponse payload: {Payload}")]
    public static partial void LogExceptionDuringProcessingOfRequestresponsePayload(this ILogger logger, Exception exception, object? payload);
    ...
    public static partial void LogProcessingRequestbatchresponseForRequestidResults(this ILogger logger, object? requestId, object? resultCount);
    ...
    public static partial void LogReceivedResponseForUnknownOrTimedOut2(this ILogger logger, object? requestId);
    ...
    public static partial void LogExceptionDuringProcessingOfRequestbatchresponsePayload(this ILogger logger, Exception exception, object? payload);
    ...
    public static partial void LogHandlingIncomingEvent(this ILogger logger, object? eventType);
    [LoggerMessage(EventId = 84, Level = LogLevel.Error, Message = "Exception occurred within the event handler for {EventType}.")]
    public static partial void LogExceptionOccurredWithinTheEventHandlerFor(this ILogger logger, Exception exception, object? eventType);
    [LoggerMessage(EventId = 85, Level = LogLevel.Warning, Message = "Received event with unhandled type: {EventType}")]
    public static partial void LogReceivedEventWithUnhandledType(this ILogger logger, object? eventType);
    [LoggerMessage(EventId = 86, Level = LogLevel.Error, Message = "Critical exception during event handling for '{EventType}': {Payload}")]
    public static partial void LogCriticalExceptionDuringEventHandlingFor(this ILogger logger, Exception exception, object? eventType, object? payload);
    [LoggerMessage(EventId = 87, Level = LogLevel.Error, Message = "Exception while trying to handle event {EventType}.")]
    public static partial void LogExceptionWhileTryingToHandleEvent(this ILogger logger, Exception exception, object? eventType);
    [LoggerMessage(EventId = 88, Level = LogLevel.Warning, Message = "{RequestDescription} canceled.")]
    public static partial void LogCanceled(this ILogger logger, object? requestDescription);
    [LoggerMessage(EventId = 89, Level = LogLevel.Trace, Message = "Sending {OpCode} message...")]
    public static partial void LogSendingMessage(this ILogger logger, object? opCode);
    [LoggerMessage(EventId = 90, Level = LogLevel.Error, Message = "Serialization failed for {OpCode} message.")]
    public static partial void LogSerializationFailedForMessage(this ILogger logger, Exception exception, object? opCode);
    [LoggerMessage(EventId = 91, Level = LogLevel.Trace, Message = "{OpCode} message sent.")]
    public static partial void LogMessageSent(this ILogger logger, object? opCode);
    [LoggerMessage(EventId = 92, Level = LogLevel.Warning, Message = "Send operation for {OpCode} canceled.")]
    public static partial void LogSendOperationForCanceled(this ILogger logger, object? opCode);
    [LoggerMessage(EventId = 93, Level = LogLevel.Error, Message = "Failed to send {OpCode} message via WebSocket.")]
    public static partial void LogFailedToSendMessageViaWebsocket(this ILogger logger, Exception exception, object? opCode);
    [LoggerMessage(EventId = 94, Level = LogLevel.Debug, Message = "Failing {RequestCount} pending request(s) due to: {ExceptionType}")]
    public static partial void LogFailingPendingRequestSDueTo(this ILogger logger, object? requestCount, object? exceptionType);
