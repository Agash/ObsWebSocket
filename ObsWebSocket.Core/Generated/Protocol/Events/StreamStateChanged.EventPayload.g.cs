...
/// <summary>
/// Data payload for the StreamStateChanged event.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record StreamStateChangedPayload
{
    /// <summary>
    ...
    [JsonConstructor]
    public StreamStateChangedPayload() { }
    ...
    public StreamStateChangedPayload(bool outputActive, ObsWebSocket.Core.Protocol.Generated.OutputState outputState = default)
    {
