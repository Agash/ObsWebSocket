...
/// <summary>
/// Data payload for the VirtualcamStateChanged event.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record VirtualcamStateChangedPayload
{
    /// <summary>
    ...
    [JsonConstructor]
    public VirtualcamStateChangedPayload() { }
    ...
    public VirtualcamStateChangedPayload(bool outputActive, ObsWebSocket.Core.Protocol.Generated.OutputState outputState = default)
    {
