...
/// <summary>
/// Data required for the GetMediaInputStatus request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record GetMediaInputStatusRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public GetMediaInputStatusRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public GetMediaInputStatusRequestData(string? inputName = null, string? inputUuid = null)
    {
