...
/// <summary>
/// Data required for the RemoveInput request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record RemoveInputRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public RemoveInputRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public RemoveInputRequestData(string? inputName = null, string? inputUuid = null)
    {
