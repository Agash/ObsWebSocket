...
/// <summary>
/// Data required for the OpenInputPropertiesDialog request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record OpenInputPropertiesDialogRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public OpenInputPropertiesDialogRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public OpenInputPropertiesDialogRequestData(string? inputName = null, string? inputUuid = null)
    {
