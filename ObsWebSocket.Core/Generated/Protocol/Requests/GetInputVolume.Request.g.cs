...
/// <summary>
/// Data required for the GetInputVolume request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record GetInputVolumeRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public GetInputVolumeRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public GetInputVolumeRequestData(string? inputName = null, string? inputUuid = null)
    {
