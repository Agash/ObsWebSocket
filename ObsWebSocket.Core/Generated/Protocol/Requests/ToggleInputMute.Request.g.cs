...
/// <summary>
/// Data required for the ToggleInputMute request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record ToggleInputMuteRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public ToggleInputMuteRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public ToggleInputMuteRequestData(string? inputName = null, string? inputUuid = null)
    {
