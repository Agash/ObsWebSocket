...
/// <summary>
/// Data required for the OpenInputFiltersDialog request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record OpenInputFiltersDialogRequestData
{
    /// <summary>
    ...
    [JsonConstructor]
    public OpenInputFiltersDialogRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public OpenInputFiltersDialogRequestData(string? inputName = null, string? inputUuid = null)
    {
