...
/// <summary>
/// Data required for the GetInputAudioTracks request.
/// </summary>
/// <remarks>
...
[MessagePackObject]
public sealed partial record GetInputAudioTracksRequestData
{
    /// <summary>
    /// Name of the input
    /// </summary>
    ...
    [JsonConstructor]
    public GetInputAudioTracksRequestData() { }

    /// <summary>
    /// Initializes a new instance with all properties specified.
    /// <para>Parameters are ordered with required properties first, then optional properties (with defaults). Follows protocol definition order where possible.</para>
    /// </summary>
    public GetInputAudioTracksRequestData(string? inputName = null, string? inputUuid = null)
    {
